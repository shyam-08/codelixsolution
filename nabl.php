...
<body style="position: relative;">
    ...
    <!-- full img Start -->
     <div class="col-lg-12" style="background-image: url(img/bg011.jpeg); height: 100vh; width: 100vw;position: relative;">
        <h1 style="position: absolute;color: #03045E;top: 60%;left: 70px;font-weight: bold;font-size: 38px;">NABL testing</h1>
    ...
    <div class="about-section" style="text-align:center">
        <h3 style="color: rgb(50, 50, 151);">NABL testing</h3>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 img-fluid">
                <p>Codelixsolution has collaborated with multiple laboratories across the country to enable the domestic manufacturer to compete in all kind of tendors.</p>
                <p>It is compulsory to perform test and calibrate the product from an NABL certified labs.</p>
                <p>If manufacturer has the test reports issues by NABL labs, they can also enlist themselves on Gem portal.</p>
                <p>We deal in every kind of products such as:</p>
                <li>Telecom products</li>
